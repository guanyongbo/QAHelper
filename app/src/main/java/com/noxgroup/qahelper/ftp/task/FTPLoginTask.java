 ...
 * @Desc: FTP登录异步任务
 */
public class FTPLoginTask extends AsyncTask<Void, Integer, List<DocumentInfo>> {
    private List<DocumentInfo> dataList;
    private LoadListener listener;
    private String dir;

    public FTPLoginTask(List<DocumentInfo> dataList, LoadListener listener, String dir) {
        this.dataList = dataList;
        this.listener = listener;
        this.dir = dir;
        Log.e("SRLog", "FTPLoginTask FTPLoginTask: dir: " + dir);
    }
    ...
    protected List<DocumentInfo> doInBackground(Void... voids) {
        ...
        return FTPHelper.getInstance().listSubFile(dir);
    }
